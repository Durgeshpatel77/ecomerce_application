...
import 'package:shared_preferences/shared_preferences.dart';
  ...
  import '../../Controller/Task controller/Deletetask_notes.dart';
import '../Todos/detailtodo_page.dart';
  ...
  class TaskDetailPage extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      final DeletetaskNotes deleteController = Get.put(DeletetaskNotes());
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              if (confirm == true) {
                                ...
                                final success = await deleteController.TaskNotedelete(note['id'], token);
                                ...
                                if (success) {
                                  ...
                                  // Optional: Trigger a state update, or refetch the task details if needed
                                } else {
                                  Get.snackbar(
                                    "Failed",
